...
#define HALF_TIM_SIZE 48
int16_t tim_buffer[HALF_TIM_SIZE * 2] = {0};

void start_tim3_dma(void) {
    HAL_DMA_Start(&hdma_tim3_ch4_up, (uint32_t) &htim3.Instance->CCR1, (uint32_t) &tim_buffer[0], HALF_TIM_SIZE * 2);
}
